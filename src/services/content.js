...
function buildMockPkg(date) {
  return {
    ...
    dailyWords: [
      { wordId:'h1',word:'擘画',pinyin:'bò huà',definition:'筹划、安排',examContext:'常搭配"蓝图"',commonMistakes:'易误读为bì',sourceSentence:'党的二十届三中全会擘画了进一步全面深化改革的宏伟蓝图。',sourceArticle:'人民日报评论',sourceDate:'2026-06-02',category:'政治类',isHighFreq:true},
      { wordId:'h2',word:'踔厉奋发',pinyin:'chuō lì fèn fā',definition:'精神振奋、斗志昂扬',examContext:'新时代精神状态',commonMistakes:'书写易误',sourceSentence:'全党全国各族人民踔厉奋发、勇毅前行。',sourceArticle:'新华社时政',sourceDate:'2026-06-02',category:'政治类',isHighFreq:true},
      { wordId:'h3',word:'行稳致远',pinyin:'xíng wěn zhì yuǎn',definition:'稳步前进才能到达远方',examContext:'经济政策表述',commonMistakes:'"致"不可写作"至"',sourceSentence:'坚持稳中求进工作总基调，推动经济行稳致远。',sourceArticle:'人民日报评论',sourceDate:'2026-06-02',category:'经济类',isHighFreq:true},
      { wordId:'h4',word:'新质生产力',pinyin:'xīn zhì shēng chǎn lì',definition:'以科技创新为主导的先进生产力',examContext:'经济板块必考',commonMistakes:'不可简单等同高科技',sourceSentence:'发展新质生产力是推动高质量发展的内在要求和重要着力点。',sourceArticle:'新华社时政',sourceDate:'2026-06-02',category:'经济类',isHighFreq:true},
      { wordId:'h5',word:'守正创新',pinyin:'shǒu zhèng chuàng xīn',definition:'坚持正道又勇于创新',examContext:'二十大关键词',commonMistakes:'理解不深',sourceSentence:'坚持守正创新，推动理论创新和实践创新良性互动。',sourceArticle:'人民日报理论',sourceDate:'2026-06-02',category:'文化类',isHighFreq:true},
      { wordId:'h6',word:'赋能',pinyin:'fù néng',definition:'赋予能力或能量',examContext:'数字经济热词',commonMistakes:'不可滥用',sourceSentence:'以数字赋能推动政务服务从能办向好办、易办转变。',sourceArticle:'新华社时政',sourceDate:'2026-06-02',category:'经济类',isHighFreq:true},
      { wordId:'h7',word:'闭环',pinyin:'bì huán',definition:'管理流程形成完整回路',examContext:'社会治理热词',commonMistakes:'注意搭配',sourceSentence:'建立风险监测预警和闭环管理机制，实现全过程管控。',sourceArticle:'人民日报评论',sourceDate:'2026-06-02',category:'社会类',isHighFreq:true},
      { wordId:'h8',word:'对标',pinyin:'duì biāo',definition:'对照标准进行比较改进',examContext:'经济改革常用',commonMistakes:'与"对比"区分',sourceSentence:'对标国际高标准经贸规则，稳步扩大制度型开放。',sourceArticle:'新华社时政',sourceDate:'2026-06-02',category:'经济类',isHighFreq:true},
      { wordId:'h9',word:'牛鼻子',pinyin:'niú bí zi',definition:'比喻事物的关键或主要矛盾',examContext:'改革话题常用比喻',commonMistakes:'非正式书面语慎用',sourceSentence:'牵住科技创新这个"牛鼻子"，走好先手棋。',sourceArticle:'新华社时政',sourceDate:'2026-06-02',category:'政治类',isHighFreq:true},
      { wordId:'h10',word:'硬骨头',pinyin:'yìng gǔ tou',definition:'比喻艰巨的任务或顽固的问题',examContext:'改革攻坚常用',commonMistakes:'搭配注意',sourceSentence:'敢于啃硬骨头，敢于涉险滩，推动改革不断深化。',sourceArticle:'人民日报评论',sourceDate:'2026-06-02',category:'政治类',isHighFreq:true},
      { wordId:'p1',word:'沙盒监管',pinyin:'shā hé jiān guǎn',definition:'在可控空间内测试新业态',examContext:'金融科技热点',commonMistakes:'新概念需理解本质',sourceSentence:'探索建立金融科技沙盒监管机制，在防控风险的前提下鼓励创新。',sourceArticle:'新华社时政',sourceDate:'2026-06-02',category:'经济类',isHighFreq:false},
      { wordId:'p2',word:'制度型开放',pinyin:'zhì dù xíng kāi fàng',definition:'以规则规制管理标准对接为主的开放',examContext:'高水平开放新提法',commonMistakes:'与商品开放区分',sourceSentence:'稳步扩大规则、规制、管理、标准等制度型开放。',sourceArticle:'人民日报评论',sourceDate:'2026-06-02',category:'经济类',isHighFreq:false},
      { wordId:'p3',word:'先立后破',pinyin:'xiān lì hòu pò',definition:'先建立新机制再破除旧机制',examContext:'改革方法论',commonMistakes:'与"先破后立"相反',sourceSentence:'推进改革要坚持先立后破，确保平稳过渡。',sourceArticle:'人民日报评论',sourceDate:'2026-06-02',category:'政治类',isHighFreq:false},
      { wordId:'p4',word:'微治理',pinyin:'wēi zhì lǐ',definition:'针对微小单元的精细化治理',examContext:'基层治理热词',commonMistakes:'冷门新词',sourceSentence:'以社区微治理为抓手，打通服务群众最后一公里。',sourceArticle:'新华社时政',sourceDate:'2026-06-02',category:'社会类',isHighFreq:false},
      { wordId:'p5',word:'全链条',pinyin:'quán liàn tiáo',definition:'涵盖全部环节',examContext:'安全监管常用',commonMistakes:'与"全流程"区别',sourceSentence:'建立全链条监管体系，从源头到终端守住安全底线。',sourceArticle:'人民日报评论',sourceDate:'2026-06-02',category:'社会类',isHighFreq:false},
    ],
    essayPassage: {
