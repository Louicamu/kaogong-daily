...
function buildMockPkg(date) {
  return {
    ...
    dailyWords: [
      { wordId:'h1',word:'擘画',pinyin:'bò huà',definition:'筹划、安排',examContext:'常搭配"蓝图"',commonMistakes:'易误读为bì',category:'政治类',isHighFreq:true},
      { wordId:'h2',word:'踔厉奋发',pinyin:'chuō lì fèn fā',definition:'精神振奋、斗志昂扬',examContext:'新时代精神状态',commonMistakes:'书写易误',category:'政治类',isHighFreq:true},
      ...
      { wordId:'h4',word:'新质生产力',pinyin:'xīn zhì shēng chǎn lì',definition:'以科技创新为主导的先进生产力',examContext:'经济板块必考',commonMistakes:'不可简单等同高科技',category:'经济类',isHighFreq:true},
      { wordId:'h5',word:'守正创新',pinyin:'shǒu zhèng chuàng xīn',definition:'坚持正道又勇于创新',examContext:'二十大关键词',commonMistakes:'理解不深',category:'文化类',isHighFreq:true},
      { wordId:'h6',word:'赋能',pinyin:'fù néng',definition:'赋予能力或能量',examContext:'数字经济热词',commonMistakes:'不可滥用',category:'经济类',isHighFreq:true},
      { wordId:'h7',word:'闭环',pinyin:'bì huán',definition:'管理流程形成完整回路',examContext:'社会治理热词',commonMistakes:'注意搭配',category:'社会类',isHighFreq:true},
      { wordId:'h8',word:'对标',pinyin:'duì biāo',definition:'对照标准进行比较改进',examContext:'经济改革常用',commonMistakes:'与"对比"区分',category:'经济类',isHighFreq:true},
